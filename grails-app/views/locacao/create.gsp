...
<div id="content" role="main">
    <div class="container">
        <section class="row">
            <a href="#create-locacao" class="skip" tabindex="-1"><g:message code="default.link.skip.label"
        ...
        <section class="row">
            <div id="create-locacao" class="col-12 content scaffold-create" role="main">
